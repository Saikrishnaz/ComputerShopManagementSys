...
Public Class ItemReport
    ...
    Private Sub BusReport_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        AutoCompleteSearchBoxForTextBoxesTypeString(con, Txt_BusName, "ItemName", "ItemData", 0)
    End Sub
    ...
    Private Sub Txt_BusName_TextChanged(sender As Object, e As EventArgs) Handles Txt_BusName.TextChanged
        ...
        Else
            ...
            Try
                ...
                Dim sql As String = "SELECT * FROM ItemData WHERE ItemName = @Name"
                ...
                DataGridView1.DataSource = ds.Tables("ItemData")
    ...
    Private Sub Guna2GradientButton1_Click(sender As Object, e As EventArgs) Handles Guna2GradientButton1.Click
        If Not Txt_BusName.Text = "" Then
            Try
                con.Open()
                Dim query As String = "DELETE FROM ItemData WHERE ItemName = @Name"
                Using cmd As New SqlCommand(query, con)
                    ...
                    If rowsAffected > 0 Then
                        MsgBox("Item Data has been successfully deleted.")
                        Txt_BusName.Clear()
                    Else
                        MsgBox("No matching record found for the provided Item Name.")
                    End If
                End Using
                con.Close()
